...
Note: Hochrechnung-Jahresumsatzwerte lebten frueher hier (hochrechnung.json),
sind aber durable und Partner-ID/Gruppenname-gebunden geworden und liegen
jetzt in swipay.db -- siehe hochrechnung_store.py. Sie ueberleben einen Reset
bewusst, genau wie die Gruppen-Zuordnungen (db_groups.py).
"""
